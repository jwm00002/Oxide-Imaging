...
for j = -1:-0.1:-1.6
    ...
    for k = -0.2:0.1:1
        disp("Run: "+l)
        [Nb2O5,NbO2,NbO,residual_avg] = XraySpecFunctions.xray_percentAnalysis(mapData,mapEnergies,i,"NewNbref.txt",0,"Nb2O5 Data.txt",0,"NbO2 Data.txt",k,"Nb2O5 Data.txt",j);
...
T = table(dataShift',NbOShift',NbO2Shift',Nb2O5Percent',NbO2Percent',NbOPercent',residualAvg');
writetable(T,'NboptimizationData.xls','WriteRowNames',true);